...
public class UserService {
    ...
    public Boolean saveDocumentToIndex(UserRequestDto.request userRequestDto) {
    ...
    public User findById(UserRequestDto.request UserRequestDto) {
        User user = null;
        try {
            user = getUserContentsFromDocument(UserRequestDto.toEntity());
        } catch (IOException e) {
